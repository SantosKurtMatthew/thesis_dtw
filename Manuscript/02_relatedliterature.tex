...
Figure 2.2: A box made using the subsets $A_{2}$ and $B_{3}$.
...
Figure 2.3: A Sample Staircase Path.
...
Figure 2.4: A visualization of L and R in a $4\times4$ box .
...
Figure 2.2: Two Sample Paths $P_{v,w}$ and $P^*_{v,w}$.
